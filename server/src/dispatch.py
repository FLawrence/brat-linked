...
from norm import norm_get_name, norm_search, norm_get_data, norm_create_local, norm_get_local_entities, norm_create_link, norm_update_link, norm_delete_local
